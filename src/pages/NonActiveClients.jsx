...
//     const result = await axios.get(`http://localhost:5000/paginatedUsers?page=${currentPage.current}&limit=${limit}&search=${searchQuery}`);
//     console.log(result);
...
//     await axios.put(`http://localhost:5000/addUser/${id}`)
...
//               <div className={style.heading}>Non-Active Clients</div>
...
//                                   <button onClick={() => handleDelete(data._id)} className={style.delete_btn} title='Delete'>Delete</button>

//                                   <button onClick={() => handleUpdate(data._id)} className={style.userUpdate_btn} title='Add'>Add</button>
//                                 </td>
//                               </tr> : ""}
//                           </>
//                         );
...
// export default NonActiveClients
