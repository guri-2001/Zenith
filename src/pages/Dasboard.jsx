                  ...
                  <Table sx={{
                    ...
                    <TableBody>
                      {allusers.map((row) => (
                        ...
                        >
                          <TableCell sx={{ display: "flex", gap: "20px", padding: "10px" }} className={style.recent_user_name_div} component="th" scope="row"><img
                            src={require(`../images/${row.image}`)}
                            height={45}
                            width={45}
                            alt=""
                            style={{ objectFit: "cover", borderRadius: "50%" }} />{row.name}</TableCell>
