...
//     await axios.put(`http://localhost:5000/userUpdate/${updateForm._id}`, { name, fname, mobileno, dob, weight, address })
//       .then((result) => navigate.refresh())
//       .catch((err) => console.log(err))
...
//       <div className={style.heading}>All Clients</div>
...
//                         <td>{data.weight}</td>
//                         <td>{data.address}</td>
//                         <td style={{ display: "flex", gap: "10px", flexDirection: "column", alignContent: "center", justifyContent: "center" }}>
//                           <button onClick={() => handleUpdate(data._id)} className={style.delete_btn} title='Remove'>In-Active</button>
//                           <button onClick={() => handleUserUpdate(data)} className={style.userUpdate_btn} title='Remove'>Edit</button>
//                         </td>
//                       </tr>
//                       : ""}
//                   </>
...
//       </div>
//       <input type="file" name="" id="" accept="image/*" value={updateForm.image} onChange={handleFieldChange} className={style1.image} />
//     </div> */}
//           <div className={style1.input_div}>
//             <div className={style1.label_div}>
...
//             </div>
//             <input type="text" name="father_name" id="" value={updateForm.fname} onChange={handleFieldChange} />
//           </div>
//           <div className={style1.input_div}>
//             <div className={style1.label_div}>
//               <label htmlFor="">Mobile No*</label>
//             </div>
//             <input type="text" name="mobile_no" id="" value={updateForm.mobileno} onChange={handleFieldChange} />
//           </div>
//           <div className={style1.input_div}>
//             <div className={style1.label_div}>
